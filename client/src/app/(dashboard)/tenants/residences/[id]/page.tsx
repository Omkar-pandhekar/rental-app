      ...
      <div className="border rounded-lg p-6">
        <div>
            ...
            <div className="flex flex-col justify-between">
              <div>
                <div className="flex items-start gap-5">
                  ...
                  <span className="text-sm font-medium border border-zinc-700 text-zinc-700 px-3 py-1 rounded-full">
                    Default
                  </span>
                </div>
          ...
          <div className="flex justify-end">
            <button className="bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-md flex items-center justify-center hover:bg-zinc-700 hover:text-zinc-50">
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden p-6 flex-1 flex flex-col justify-between">
      ...
      <div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="border-[0.5px] border-zinc-300 h-4" />
          <div className="xl:flex">
          ...
          <TableBody>
            {payments.map((payment) => (
              <TableRow key={payment.id} className="h-16">
                ...
                <TableCell>
                  <button className="border border-gray-300 text-gray-700 py-2 px-4 rounded-md flex items-center justify-center font-semibold hover:bg-zinc-700 hover:text-zinc-50">
